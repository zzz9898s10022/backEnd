            ...
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ol>
                    <li><strong>MOBILE FRIENDLY</strong> - no special actions required, all sites you make with Mobirise
                        ...
                        adapt automagically. <a href="">Try it now!</a></li>
                    <li><strong>EASY AND SIMPLE</strong> - cut down the development time with drag-and-drop website
                        ...
                        required. <a href="">Try it now!</a></li>
                    <li><strong>UNIQUE STYLES</strong> - choose from the large selection of latest pre-made blocks -
                        ...
                        parallax scrolling, video backgrounds, hamburger menu, sticky header and more. <a href="">Try it
                            now!</a></li>
                </ol>
            </div>
        </div>
